				...
				<div class="sidebar-inner slimscrollleft">
					...
					<div id="sidebar-menu">
						...
						<ul>
							...
							<li class="has_sub">
								<a class="waves-effect" href="javascript:void(0);"><i class="mdi mdi-view-dashboard"></i><span
							...
							<li class="has_sub">
								<a class="waves-effect" href="javascript:void(0);"><i class="mdi mdi-invert-colors"></i> <span> User
							...
							<li class="has_sub">
								<a class="waves-effect" href="javascript:void(0);"><i class="mdi mdi-layers"></i><span> Admin UI </span>
							...
							<li>
								<a class="waves-effect" href="calendar.html"><i class="mdi mdi-calendar"></i><span> Calendar </span></a>
							</li>

							<li class="has_sub">
								<a class="waves-effect" href="javascript:void(0);"><i class="mdi mdi-email"></i><span> Email </span> <span
							...
							<li class="has_sub">
								<a class="waves-effect" href="javascript:void(0);"><i class="mdi mdi-heart-outline"></i><span> Icons </span>
									<span class="menu-arrow"></span></a>
								<ul class="list-unstyled">
							...
							<li class="has_sub">
								<a class="waves-effect" href="javascript:void(0);"><i class="mdi mdi-diamond"></i><span
							...
							<li class="has_sub">
								<a class="waves-effect" href="javascript:void(0);"><i class="mdi mdi-format-list-bulleted"></i> <span> Tables
							...
							<li class="has_sub">
								<a class="waves-effect" href="javascript:void(0);"><i class="mdi mdi-chart-arc"></i><span> Charts </span>
									<span class="menu-arrow"></span></a>
								<ul class="list-unstyled">
							...
							<li class="has_sub">
								<a class="waves-effect" href="javascript:void(0);"><i class="mdi mdi-map"></i> <span> Maps </span> <span
										class="menu-arrow"></span></a>
								<ul class="list-unstyled">
							...
							<li class="has_sub">
								<a class="waves-effect" href="javascript:void(0);"><i class="mdi mdi-google-pages"></i><span> Pages </span>
									<span class="menu-arrow"></span></a>
								<ul class="list-unstyled">
							...
							<li class="has_sub">
								<a class="waves-effect" href="javascript:void(0);"><i class="mdi mdi-gift"></i><span> Extras </span> <span
										class="menu-arrow"></span></a>
								<ul class="list-unstyled">
							...
							<li class="has_sub">
								<a class="waves-effect" href="javascript:void(0);"><i class="mdi mdi-comment-text-outline"></i><span> Blog
									</span> <span class="menu-arrow"></span></a>
								<ul class="list-unstyled">
							...
							<li class="has_sub">
								<a class="waves-effect" href="javascript:void(0);"><i class="mdi mdi-home-map-marker"></i><span> Real Estate
									</span> <span class="menu-arrow"></span></a>
								<ul class="list-unstyled">
					...
					<div class="container">
						...
						<div class="row text-center">
							...
							<div class="col-lg-2 col-md-4 col-sm-6">
								<div class="card-box widget-box-one">
									<div class="wigdet-one-content">
										<p class="text-uppercase font-600 font-secondary text-overflow m-0">Statistics</p>
							...
							<div class="col-lg-2 col-md-4 col-sm-6">
								<div class="card-box widget-box-one">
									<div class="wigdet-one-content">
										<p class="text-uppercase font-600 font-secondary text-overflow m-0">User Today</p>
							...
							<div class="col-lg-2 col-md-4 col-sm-6">
								<div class="card-box widget-box-one">
									<div class="wigdet-one-content">
										<p class="text-uppercase font-600 font-secondary text-overflow m-0">User This Month</p>
							...
							<div class="col-lg-2 col-md-4 col-sm-6">
								<div class="card-box widget-box-one">
									<div class="wigdet-one-content">
										<p class="text-uppercase font-600 font-secondary text-overflow m-0">Request Per Minute</p>
							...
							<div class="col-lg-2 col-md-4 col-sm-6">
								<div class="card-box widget-box-one">
									<div class="wigdet-one-content">
										<p class="text-uppercase font-600 font-secondary text-overflow m-0">Total Users</p>
							...
							<div class="col-lg-2 col-md-4 col-sm-6">
								<div class="card-box widget-box-one">
									<div class="wigdet-one-content">
										<p class="text-uppercase font-600 font-secondary text-overflow m-0">New Downloads</p>
										...
										<div class="table-responsive">
											<table class="table-hover m-0 table table">
												...
												<tbody>
													<tr>
														<th>
															<img class="thumb-sm img-circle" src="/assets/images/users/avatar-1.jpg" alt="user" />
														</th>
														<td>
													...
													<tr>
														<th>
															<img class="thumb-sm img-circle" src="/assets/images/users/avatar-2.jpg" alt="user" />
														</th>
														<td>
													...
													<tr>
														<th>
															<img class="thumb-sm img-circle" src="/assets/images/users/avatar-3.jpg" alt="user" />
														</th>
														<td>
													...
													<tr>
														<th>
															<img class="thumb-sm img-circle" src="/assets/images/users/avatar-4.jpg" alt="user" />
														</th>
														<td>
													...
													<tr>
														<th>
															<img class="thumb-sm img-circle" src="/assets/images/users/avatar-5.jpg" alt="user" />
														</th>
														<td>
