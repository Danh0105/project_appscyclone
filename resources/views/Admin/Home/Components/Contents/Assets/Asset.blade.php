		...
		<div class="col-sm-12">
			<div class="card-box table-responsive">
				...
				<div class="row" style="display: flex;justify-content: right;margin:5px;">
					<a class="btn btn-primary waves-effect w-md waves-light" type="button" href="{{ route("locations.create") }}"
						style="margin:10px">NEW
						ASSET</a>
					<button class="btn btn-primary waves-effect w-md waves-light" type="button" style="margin:10px">IMPORT
						ASSET</button>
				</div>
				<div class="tab-content">
					...
					<div class="tab-pane active" id="department1">
						Department
					</div>
				</div>
