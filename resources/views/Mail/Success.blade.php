							...
							<div class="m-t-40 account-pages">
								<div class="account-logo-box text-center">
									<h2 class="text-uppercase">
										<a class="text-success" href="index.html">
											<span><img src="https://appscyclone.com/_nuxt/img/logo.d04fdce.svg" alt="" height="36"></span>
										</a>
									</h2>
								...
								<div class="account-content">
									<div class="m-b-20 text-center">
										<div class="m-b-20">
											<div class="checkmark">
												<svg id="Layer_1" version="1.1" xmlns="http://www.w3.org/2000/svg"
													...
													<circle class="path" fill="none" stroke="#4bd396" stroke-width="4" stroke-miterlimit="10"
														cx="80.6" cy="80.6" r="62.1" />
													<polyline class="path" fill="none" stroke="#4bd396" stroke-width="6" stroke-linecap="round"
														stroke-miterlimit="10"
														points="113,52.8
                                                        74.1,108.4 48.2,86.4 " />

													<circle class="spin" fill="none" stroke="#4bd396" stroke-width="4" stroke-miterlimit="10"
										...
										<p class="text-muted font-13 m-t-10"> A email has been send to <b>{{ $email }}</b>. Please check for an
